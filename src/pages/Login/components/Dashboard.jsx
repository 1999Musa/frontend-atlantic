...
export default function Dashboard() {
  ...
  return (
    <div className="min-h-screen flex bg-slate-100 mt-22">
      ...
      {/* SIDEBAR */}
      <aside className="w-20 bg-white border-r shadow-md flex flex-col items-center py-6 space-y-8">

        <div className="text-lg font-bold text-slate-900">ATL</div>
        ...
        <SidebarIcon icon={<TagIcon className="w-7" />} label="Prices" />
        <SidebarIcon icon={<Cog6ToothIcon className="w-7" />} label="Settings" />

        {/* Bottom Logout */}
        <div className="mt-auto pb-6">
          <button onClick={logout}>
            <ArrowRightOnRectangleIcon className="w-7 text-red-500 hover:text-red-600" /> OUT
          </button>
        </div>
      </aside>
