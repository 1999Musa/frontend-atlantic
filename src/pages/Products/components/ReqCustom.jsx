        ...
        <section className="py-10 px-8 md:px-12 font-[Poppins]">
          ...
          <form onSubmit={handleSubmit} noValidate>
            ...
            <div className="mb-8">
              ...
              <div
                className={`group relative border-2 border-dashed rounded-xl p-8 flex flex-col items-center justify-center cursor-pointer transition-all duration-300
              ...
              >
                {file ? (
                  ...
                  <div className="text-center">
                    <CloudArrowUpIcon className="w-12 h-12 mx-auto text-gray-400 group-hover:text-indigo-500 transition-colors mb-2" />
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
              ...
              <div>
                ...
                <input
                  ...
                  className={`w-full px-4 py-3 bg-gray-50 border rounded-lg focus:bg-white focus:ring-2 focus:ring-indigo-200 focus:border-indigo-400 outline-none transition-all ${errors.name ? "border-red-500" : "border-gray-200"}`}
              ...
              <div>
                ...
                <input
                  ...
                  className={`w-full px-4 py-3 bg-gray-50 border rounded-lg focus:bg-white focus:ring-2 focus:ring-indigo-200 focus:border-indigo-400 outline-none transition-all ${errors.email ? "border-red-500" : "border-gray-200"}`}
              ...
              <div>
                ...
                <div className="flex gap-2">
                  <select
                    ...
                    className="px-3 py-3 bg-gray-50 border border-gray-200 rounded-lg outline-none focus:border-indigo-400"
                  >
                    <option>+91</option>
                    <option>+1</option>
                    <option>+44</option>
                  ...
                  <input
                    ...
                    className={`w-full px-4 py-3 bg-gray-50 border rounded-lg focus:bg-white focus:ring-2 focus:ring-indigo-200 focus:border-indigo-400 outline-none transition-all ${errors.phoneNumber ? "border-red-500" : "border-gray-200"}`}
                  />
                </div>
              ...
              {/* Quantity */}
              <div>
                <label className="block text-sm font-semibold text-gray-700 mb-1">Quantity (Min 100) *</label>
                <div className="relative">
                  <select
                    ...
                    className={`w-full px-4 py-3 bg-gray-50 border rounded-lg appearance-none focus:bg-white focus:ring-2 focus:ring-indigo-200 focus:border-indigo-400 outline-none transition-all ${errors.quantity ? "border-red-500" : "border-gray-200"}`}
                  >
            ...
            {/* Message */}
            <div className="mb-8">
              <label className="block text-sm font-semibold text-gray-700 mb-1">Customization Details *</label>
              <textarea
                disabled={loading}
                value={form.message}
                onChange={(e) => {
                ...
                rows="4"
                className={`w-full px-4 py-3 bg-gray-50 border rounded-lg focus:bg-white focus:ring-2 focus:ring-indigo-200 focus:border-indigo-400 outline-none transition-all resize-none ${errors.message ? "border-red-500" : "border-gray-200"}`}
              ></textarea>
            ...
            <div className="flex justify-center">
              <button
                ...
                disabled={loading}
                className={`
                  w-full md:w-auto px-8 py-3.5 rounded-lg text-white font-semibold text-lg shadow-lg shadow-indigo-500/30 flex items-center justify-center gap-2 transition-all transform active:scale-95
                  ${loading ? "bg-indigo-400 cursor-wait" : "bg-indigo-600 hover:bg-indigo-700 hover:-translate-y-0.5"}
                `}
              >
                {loading ? (
                  <>
